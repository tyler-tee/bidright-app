// src/views/ResultView.js - Updated to use ProjectProfitabilityAnalysis instead of competitor rates
import React from 'react';
import { industries, projectTypes, featureOptions } from '../data/industryData';
import EnhancedPdfExport from '../components/premium/EnhancedPdfExport';
import ProjectBreakdown from '../components/premium/ProjectBreakdown';
import RiskAssessment from '../components/premium/RiskAssessment';
import ProjectProfitabilityAnalysis from '../components/premium/ProjectProfitabilityAnalysis';
...
Generated by BidRight.app | ${window.location.origin}
  ...
  // Create metadata object for premium components
  const metadata = {
    industryName: industries.find(i => i.id === industry)?.name || 'Unknown',
    projectName: projectTypes[industry]?.find(p => p.id === projectType)?.name || 'Unknown',
        ...
        <div className="p-6">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            ...
            <button 
              ...
              onClick={() => handleAccountAction('Pro upgrade')}
            >
      ...
      <div className="space-y-8">
        ...
        {hasFeature('export_pdf') && (
          <EnhancedPdfExport 
            ...
            metadata={metadata}
            isUserPro={true}
            isPremium={hasFeature('white_label')}
            onExport={() => trackEvent('pdf_exported')}
          />
        )}
        
        {/* Project Breakdown */}
        {hasFeature('project_breakdown') && (
          <ProjectBreakdown 
            industry={industry}
        ...
        {/* Project Profitability Analysis - replacing Competitor Rates */}
        {hasFeature('profitability_analysis') && (
