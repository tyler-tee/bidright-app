                ...
                {emailSubmitted ? (
                  ...
                  <>
                    <div className="flex">
                      ...
                      />
                      <button 
                        className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-r-lg transition-colors"
                        onClick={handleSubscribe}
                      >
                        Subscribe
                      </button>
...
export default FreelanceEstimator;